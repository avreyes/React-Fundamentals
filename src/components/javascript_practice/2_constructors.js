...
console.log(userOne); // User {f: "Paul", 1: "O'Connor", email: "poconnor@elevenfifty.org"}

// Challenge: Write a Car class with make, model, and year.
...
let carOne = new Car("Tesla", "Model 3", "2021");
console.log(carOne.first);
console.log(carOne.m);
console.log(carOne.o);
console.log(carOne);