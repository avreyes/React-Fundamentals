        ...
        <div className="main">
            <div className="mainDiv">
                ...
                <ul>
                    ...
                    <li>
                        <a href="https://wwww.udemy.com/course/react-the-guide-incl-redux" target="_blank">
                            Maximilian Shwarzmuller's Udemy Course
                        </a>
                    </li>
                    <li>
                        <a href="https://reactstrap.github.id/" target="_blank">
